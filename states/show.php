...
<div id="main-content">
  <a href="\Projects\globitek\public\staff\states\index.php">Back to States List</a><br />
...
?>
    <br />
    <a href="edit.php?id=".$state['id']>Edit</a><br />
    <hr />

    <h2>Territories</h2>
    <br />
    <a href="\Projects\globitek\public\staff\territories\new.php">Add a Territory</a><br />
...
<?php
    ...
    while($territory = db_fetch_assoc($territory_result)) {
      echo "<li>";
      echo "<a href=\"\Projects\globitek\public\staff\territories\show.php?id=\"".$territory['id']."\">";
      echo $territory['name'];
      echo "</a>";
      echo "</li>";
    } // end while $territory
